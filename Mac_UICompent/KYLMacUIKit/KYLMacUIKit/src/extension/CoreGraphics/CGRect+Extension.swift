...
public extension CGRect {
    ...
    static func union(rects: [CGRect], points: [CGPoint]) -> CGRect {
       guard !rects.isEmpty else { return CGRect.unionRects(rects) }
    ...
    extension CGRect {
        ...
        /// 返回`CGRect`，其中`self`以`rect`居中。
        /// - Parameter rect:以`rect`居中
        /// - Parameter xOffset: rect.width的偏移量。
        /// - Parameter yOffset: rect.height的偏移量。
        func centered(
            in rect: Self,
            xOffset: Double = 0,
            yOffset: Double = 0
        ...
        ///  返回一个CGRect，其中“ self”以“ rect”为中心。
        /// - Parameter rect:以“ rect”为中心
        /// - Parameter xOffsetPercent: rect.width百分比的偏移量。
        /// - Parameter yOffsetPercent: rect.height百分比的偏移量。
        func centered(
            in rect: Self,
