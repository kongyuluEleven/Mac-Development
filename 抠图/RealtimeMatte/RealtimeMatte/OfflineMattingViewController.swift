//
//  OfflineMattingViewController.swift
//  RealtimeMatte
//
...
/// 离线抠图并生成视频
class OfflineMattingViewController: UIViewController {
    ...
    fileprivate var compositionHandler: AsyncVideoMatteCompositionHandler?
...
fileprivate extension OfflineMattingViewController {
    ...
    func configVideoPlayer(_ videoAsset: AVURLAsset?) {
        ...
        compositionHandler = AsyncVideoMatteCompositionHandler(context: context,
