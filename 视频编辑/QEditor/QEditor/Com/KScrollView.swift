...
class KScrollView: UIScrollView {
    ...
    private var gridView: KGridView!
    ...
    override init(frame: CGRect) {
        ...
        gridView = KGridView(frame: bounds)
...
extension KScrollView: UIScrollViewDelegate {
...
extension KScrollView: UIGestureRecognizerDelegate {
