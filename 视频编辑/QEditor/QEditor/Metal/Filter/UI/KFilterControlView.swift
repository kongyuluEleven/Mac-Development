...
protocol KFilterControlViewDelegate {
...
class KFilterControlView: UIView {

    var delegate: KFilterControlViewDelegate?
    ...
    private let sliderView: KHorizontalSliderView
    
    private let filterTool: KFilterToolItem
    
    init(frame: CGRect, filterTool: KFilterToolItem, value: Float = 1.0) {
        ...
        sliderView = KHorizontalSliderView(frame: CGRect(x: 30, y: frame.height/2 - 50, width: frame.width - 60, height: 70))
